            ...
            onClick={() =>
              setModalContent(
                <div className="flex flex-col items-center w-full max-w-md mx-auto text-center gap-4">
                  ...
                  <p className="text-sm text-left text-gray-700 leading-relaxed">
                    With every unopened LEGO set, the legend grows. Friends
                    laugh, shelves sag, and resale value fluctuates — but the
                    mission is clear: preserve potential, defer joy, and hoard
                    with purpose.
                  </p>
                  ...
                  <div className="w-full max-w-3xl bg-white text-black p-6 md:p-10 overflow-auto space-y-6">
                    ...
                    <section>
                      ...
                      <p className="text-sm leading-relaxed text-gray-700">
                        Creative and dedicated frontend developer with over 1
                        year of experience building dynamic, responsive websites
                        and immersive 3D user interfaces. Strong understanding
                        of modern JavaScript frameworks, performance
                        optimization, and user-centered design principles.
                      </p>
                    </section>
                ...
                setModalContent(
                  <div className="flex flex-col items-center w-full max-w-md mx-auto text-center gap-4">
                    ...
                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      Brickify is a vibrant blog platform built during my time
                      at Noroff, created for fellow LEGO enthusiasts. It
                      features dynamic content loading, search filtering,
                      pagination, and a responsive carousel for showcasing the
                      latest builds. With full user authentication and blog
                      management tools, it’s designed to be both playful and
                      practical — a digital space to celebrate bricks and
                      creativity.
                    </p>
                ...
                setModalContent(
                  <div className="flex flex-col items-center w-full max-w-md mx-auto text-center gap-4">
                    ...
                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      ...
                      JavaScript, the game lets players create their own hero
                      and embark on branching adventures filled with traders,
                      encounters, and turn-based battles.
                    </p>

                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      Players can choose from distinct classes like mage,
                      warrior, or rogue — each with unique stats and playstyles.
                      The map system generates random encounter paths ending in
                      boss fights, while progression is tracked through battles
                    ...
                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      ...
                      planning and replayability. Defeat the boss to continue —
              ...
              onClick={() =>
                setModalContent(
                  <div className="flex flex-col items-center w-full max-w-md mx-auto text-center gap-4">
                    ...
                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      Holidaze is a responsive React-based booking platform
                      built for my Noroff final project. It features venue
                      filtering, user authentication, and a hero video landing
                      page — all styled with Tailwind and built for performance.
                    </p>
                ...
                setModalContent(
                  <div className="flex flex-col items-center w-full max-w-md mx-auto text-center gap-4">
                    ...
                    <p className="text-lg text-left text-gray-700 leading-relaxed">
                      ...
                      users to explore live auctions, place bids, and create
                      their own listings. Featuring user authentication, listing
